...
export const addUser = async (userName, name, surname, userTypeId, tcnumber, email, phoneNumber, plate, rolId) => {
  const auth = getStorgeItem('auth');
...
export const updateUser = async (id, userName, name, surname, userTypeId, tcnumber, email, phoneNumber, plate, rolId) => {
  const auth = getStorgeItem('auth');
...
export const updateApartment = async (id, apartmentBlockNo, apartmentType, apartmentFloor, apartmentNo, userId) => {
  const auth = getStorgeItem('auth');
...
export const deleteApartment = async (id) => {
  ...
  return axios.put(APP_URL + '/api/Apartment/DeleteApartment?apartmentId=' + id, {},{
    headers: {
      'Authorization': `Bearer ${auth.accessToken}`
    }
  })
...
export const getAllApartments = async () => {
  ...
  return axios.get(APP_URL + "/api/Apartment/GetAllActiveApartments", {
    headers: {
      'Authorization': `Bearer ${auth.accessToken}`
    }
  })
...
export const getCreditCardInfo = async (userId) => {
  const auth = getStorgeItem('auth'); 
  return axios.get('http://localhost:57520/api/Payment/GetByUserId?userId=' + userId, {
    headers: {
      'Authorization': `Bearer ${auth.accessToken}`
    }
  })
...
export const MarkRead = (relatedUserId) => {
  const auth = getStorgeItem('auth');
  return axios.post(APP_URL + '/api/Message/MarkRead?relatedUserId=' + relatedUserId, {}, {
    headers: {
      'Authorization': `Bearer ${auth.accessToken}`
    }
  })
